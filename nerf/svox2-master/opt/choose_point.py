...
group.add_argument('--corx', type=int, default='0',
                     help='x coordinate of the UI choosing point')

group.add_argument('--cory', type=int, default='0',
                     help='y coordinate of the UI choosing point')
